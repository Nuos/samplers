...
{
    shaderLoader.load("/Users/wistoneqqx/Documents/opengl/opengl-study-records/texture-maps-gl8/texture-maps/simpleShader.vert",
                      "/Users/wistoneqqx/Documents/opengl/opengl-study-records/texture-maps-gl8/texture-maps/simpleShader.frag");
    shaderLoader.bind();
...
int main(void)
{
    ...
    if(false==LoadImg("/Users/wistoneqqx/Documents/opengl/opengl-study-records/texture-maps-gl8/texture-maps/test01.jpg",0))
        printf("加载图片1失败！\n");
    
    if(false==LoadImg("/Users/wistoneqqx/Documents/opengl/opengl-study-records/texture-maps-gl8/texture-maps/test02.jpg",1))
        printf("加载图片2失败！\n");
    
    if(false==LoadImg("/Users/wistoneqqx/Documents/opengl/opengl-study-records/texture-maps-gl8/texture-maps/test00.jpg",2))
        printf("加载图片2失败！\n");
